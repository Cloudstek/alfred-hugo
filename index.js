...
var Hugo = function () {
    function Hugo() {
        (0, _classCallCheck3.default)(this, Hugo);
    ...
    (0, _createClass3.default)(Hugo, [{
        ...
        value: function addItem(item) {
            ...
            if (item.arg && typeof item.arg === 'object') {
                ...
                item.arg = (0, _stringify2.default)({
                    alfredworkflow: {
                        arg: arg,
                        variables: variables
                    }
        ...
        value: function addVariables(variables) {
            ...
            this._outputBuffer.variables = (0, _assign2.default)({}, this._outputBuffer.variables, variables);
                ...
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                if (!(this._options.checkUpdates !== true || this._options.updateItem !== true && this._options.updateNotification !== true)) {
                                    _context.next = 2;
                                    break;
                                }
                            ...
                            case 2:
                                _context.next = 4;
                                return updater.checkUpdates(this._options.updateSource, this._options.updateInterval).catch(function (err) {
                                    console.error(err);
                                    ...
                                    var current = _this2.workflowMeta.version;
                                    var latest = result.version;

                                    if (semver.gt(latest, current)) {
                                        if (result.checkedOnline === true && _this2._options.updateNotification === true) {
                                            notifier.notify({
                                                title: _this2.workflowMeta.name || 'Alfred',
                                                subtitle: `Workflow version ${latest} available. Current version: ${current}.`,
                                                sender: 'com.runningwithcrayons.Alfred-3',
                                                timeout: 10
                                            });
                                        }
                                        if (_this2._options.updateItem === true) {
                                            _this2.addItem({
                                                title: `Workflow update available!`,
                                                subtitle: `Version ${latest} is available. Current version: ${current}.`,
                                                icon: _this2.workflowMeta.icon,
                                                arg: {
                                                    arg: result.url,
                                                    variables: {
                                                        task: 'wfUpdate'
        ...
        value: function filterItems(query) {
            ...
            options = (0, _assign2.default)({}, this._fuseDefaults, options);

            if (query.length === 0) {
                return this;
            }

            var fuse = new Fuse(this._outputBuffer.items, options);
        ...
        key: 'matches',
        value: function matches(candidates, query) {
